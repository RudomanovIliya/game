...
init python:
    ...
    if not persistent.achievements_dict:
        persistent.achievements_dict = {"*bober*": {"type": 0, # One time achievent
                                                 "title": "M!", # Also neame for steam
                                                 "text": "MMMMMMMMMMMMMM", # description
                                                 "icon": "images/icons/ach1.png" # 96x96 image
                                                             }


        #"*achievent_name*": {"type": 0, # One time achievent
